...
{
       0,    86,    86,    90,    96,   101,   106,   112,   116,   122,
     128,   135,   139,   146,   151,   157,   162,   168,   174,   179,
     183,   187,   191,   195,   199,   205,   212,   216,   223,   229,
     236,   242,   248,   255,   261,   267,   275,   281,   287,   293,
     297,   303,   307,   315,   323,   332,   336,   344,   352,   360,
     368,   376,   386,   390,   398,   408,   412,   420,   430,   437,
     443,   447,   453,   457,   463,   472
};
#endif
...
#line 158 "CminusParser.y"
    { 
			setValue((yyvsp[(1) - (1)]), g_GP_NEXT_OFFSET);
...
#line 256 "CminusParser.y"
    {
		  ...
		  issue_sw(reg, GP, getValue((yyvsp[(3) - (5)]))); // store reg's content at variable's location
		}
    break;
...
#line 308 "CminusParser.y"
    {
			reg_idx_t reg = reg_alloc();
			ISSUE_OR(reg, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]));
			reg_free((yyvsp[(1) - (3)]));
			reg_free((yyvsp[(3) - (3)]));
			(yyval) = reg;
		}
...
#line 316 "CminusParser.y"
    {
			reg_idx_t reg = reg_alloc();
			ISSUE_AND(reg, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]));
			reg_free((yyvsp[(1) - (3)]));
			reg_free((yyvsp[(3) - (3)]));
			(yyval) = reg;
		}
...
#line 337 "CminusParser.y"
    {
			reg_idx_t reg = reg_alloc();
			issue_op("seq", reg, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]));
			reg_free((yyvsp[(1) - (3)]));
			reg_free((yyvsp[(3) - (3)]));
			(yyval) = reg;
		}
...
#line 345 "CminusParser.y"
    {
			reg_idx_t reg = reg_alloc();
			issue_op("sne", reg, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]));
			reg_free((yyvsp[(1) - (3)]));
			reg_free((yyvsp[(3) - (3)]));
			(yyval) = reg;
		}
...
#line 353 "CminusParser.y"
    {
			reg_idx_t reg = reg_alloc();
			issue_op("sle", reg, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]));
			reg_free((yyvsp[(1) - (3)]));
			reg_free((yyvsp[(3) - (3)]));
			(yyval) = reg;
		}
...
#line 361 "CminusParser.y"
    {
			reg_idx_t reg = reg_alloc();
			issue_op("slt", reg, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]));
			reg_free((yyvsp[(1) - (3)]));
			reg_free((yyvsp[(3) - (3)]));
			(yyval) = reg;
		}
...
#line 369 "CminusParser.y"
    {
			reg_idx_t reg = reg_alloc();
			issue_op("sge", reg, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]));
			reg_free((yyvsp[(1) - (3)]));
			reg_free((yyvsp[(3) - (3)]));
			(yyval) = reg;
		}
...
#line 377 "CminusParser.y"
    {
			reg_idx_t reg = reg_alloc();
			issue_op("sgt", reg, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]));
			reg_free((yyvsp[(1) - (3)]));
			reg_free((yyvsp[(3) - (3)]));
			(yyval) = reg;
		}
...
#line 391 "CminusParser.y"
    {
			reg_idx_t reg = reg_alloc();
			ISSUE_ADD(reg, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]));
			reg_free((yyvsp[(1) - (3)]));
			reg_free((yyvsp[(3) - (3)]));
			(yyval) = reg;
		}
...
#line 399 "CminusParser.y"
    {
			reg_idx_t reg = reg_alloc();
			ISSUE_SUB(reg, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]));
			reg_free((yyvsp[(1) - (3)]));
			reg_free((yyvsp[(3) - (3)]));
			(yyval) = reg;
		}
...
#line 413 "CminusParser.y"
    {
			reg_idx_t reg = reg_alloc();
			ISSUE_MUL(reg, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]));
			reg_free((yyvsp[(1) - (3)]));
			reg_free((yyvsp[(3) - (3)]));
			(yyval) = reg;
		}
...
#line 421 "CminusParser.y"
    {
			reg_idx_t reg = reg_alloc();
			ISSUE_DIV(reg, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]));
			reg_free((yyvsp[(1) - (3)]));
			reg_free((yyvsp[(3) - (3)]));
			(yyval) = reg;
		}
...
#line 454 "CminusParser.y"
    {
			(yyval) = (yyvsp[(1) - (1)]); // index in symtable
		}
    break;
...
#line 464 "CminusParser.y"
    { 
			reg_idx_t reg   = reg_alloc();
			char*     label = SymGetFieldByIndex(symtab, (yyvsp[(1) - (1)]), SYM_NAME_FIELD);
			issue_la(reg, label);
			(yyval) = reg;
		}
    break;
